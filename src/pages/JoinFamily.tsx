...
export default function JoinFamily() {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: 'url("/ShiftMeUp - Website background.svg"), url(/family-background.jpg), url(/family-background.png)',
    ...
    >
      ...
      <div className="absolute inset-0 bg-white/45 sm:bg-gradient-to-r sm:from-white/65 sm:to-white/45" />
      ...
      <div className="relative z-10">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white/90 backdrop-blur-[1px] py-8 px-4 shadow-lg border border-stone-200 sm:rounded-3xl sm:px-10">
